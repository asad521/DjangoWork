...
from .forms import DetailedForm ,EditProfileForm,EditAdminProfileForm
...
def user_profile(request):
    if request.user.is_authenticated:
        ...
        return render(request, 'profileTemplate.html', {'name': request.user, 'editform':fm, 'users':users})
    else:
        return HttpResponseRedirect('/loginform/')
...
def user_details_View(request, id):
    if request.user.is_authenticated:
         ...
         return render(request, 'userDetailsTemplate.html',{'form':fm})
    else:
        HttpResponseRedirect('/loginform/')
